  ...
  return (
    <div className=' box z-2 relative'>
      ...
      <div className=' py-4 review flex  max-sm:flex-col justify-around gap-6 pt-5'>
        {
          customerReview.map((e)=>{
            return(
              <div className='bg-white/90 rounded-lg p-10 text-start flex-[1_1_auto] cursor-grab text-[17px] text-gray-500'>
                <div className='text-black'>{e.star}</div>
                <p className='text-[18px] font-medium leading-8 mb-5'>{e.review}</p>
